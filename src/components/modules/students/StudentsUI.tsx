  ...
  return (
    <div className="space-y-6 animate-fade-in">
      ...
      {showModal && (
        ...
        >
          <div
            className="bg-card border border-border/80 rounded-3xl shadow-2xl w-full max-w-xl max-h-[92vh] overflow-hidden flex flex-col transition-all"
              ...
              <div className="bg-muted/15 border border-border/50 rounded-2xl p-4 space-y-3">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  <div>
                    ...
                    <Input
                      type="email"
                      placeholder="alex.johnson@school.com"
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) => setFormData({ ...formData, parentPhone: e.target.value, parent_phone: e.target.value, guardian_phone: e.target.value })}
                      icon={<Phone className="h-4 w-4 text-muted-foreground" />}
                    />
                  </div>
                </div>
