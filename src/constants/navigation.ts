...
export const navItems: NavItem[] = [
  ...
  { path: "/reports/fees", icon: IndianRupee, label: "Fee Management", roles: ["admin", "principal"] },
  { path: "/reports/salaries", icon: Coins, label: "Salary Management", roles: ["admin", "principal"] },
